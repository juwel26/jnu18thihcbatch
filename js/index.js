...
var x = setInterval(function() {
  ...
  if (distance < 0) {
    clearInterval(x);
    document.querySelector(".timerHeadline").innerHTML    = " our  mid exam start  from today.. 🥳";
...
var x = setInterval(function() {
  ...
  if (distance < 0) {
    clearInterval(x);
   document.querySelector(".paragrap").innerHTML = "    🔥 🔥 📰 1st mid exam of 2nd semester will be start 03/03/2024. 🔥 ";
